            ...
            <div class="space-y-7 mb-20">
                ...
                <div class="bg-white p-4 rounded-xl app-shadow">
                    ...
                    <div class="flex gap-2 mb-7">
                        <f7-button fill tonal class="text-clr-primary">All</f7-button>
                        <f7-button class="text-gray-700">Unread</f7-button>
                    </div>

                    <!-- Notification List -->
                    <div class="cursor-pointer flex items-center justify-between bg-red-50 rounded-lg py-2 px-4 mb-2">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-gray-700"><span class="font-semibold">Rescuer</span> is now responded to
                                    your request.</h3>
                    ...
                    <div class="cursor-pointer flex items-center justify-between hover:bg-gray-50 rounded-lg py-2 px-4 mb-2">
                        <div class="flex items-center gap-4">
                            <!-- Icons -->
                            <div class="bg-red-100 p-2 rounded-full">
                                <svg class="w-[32px] h-[32px] text-red-500" aria-hidden="true"
